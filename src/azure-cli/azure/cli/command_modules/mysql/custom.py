...
def flexible_server_threat_model_list_func(cmd, client, resource_group_name=None, server_name=None,):
    if not client:
        raise ValueError("Invalid client provided.")
...
def flexible_server_threat_model_show_func(cmd, client, resource_group_name=None, server_name=None, advanced_threat_protection_name="default"):
    if not client:
        raise ValueError("Invalid client provided.")
